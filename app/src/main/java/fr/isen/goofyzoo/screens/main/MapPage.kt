...
//
//
//            val labelVallon = Marker(mapView).apply {
...
//
//
//            val labelPlateau = Marker(mapView).apply {
...
//
//
//            val labelClairieres = Marker(mapView).apply {
...
//
//
//            val labelBoisDesPins = Marker(mapView).apply {
...
//            mapView.overlays.add(labelClairieres)
//
//            mapView.overlays.add(polygonBoisDesPins)
//            mapView.overlays.add(labelBoisDesPins)
//
//
//            mapView
//        },
...
//fun MapPage() {
//    val startPoint = GeoPoint(43.62380, 5.20964)
//    val endPoint = GeoPoint(43.62250, 5.20700)
//
//    AndroidView(
//        factory = { ctx ->
//            Configuration.getInstance().load(ctx, ctx.getSharedPreferences("osmdroid", Context.MODE_PRIVATE))
...
//            val end = Node(endPoint.longitude, endPoint.latitude)
//            val path = graph.shortestPath(start, end)
//
//            val line = Polyline()
//            line.title = "Itinéraire"
//            line.setColor(Color.BLUE)
//            line.setWidth(6f)
//            line.setPoints(path.map { GeoPoint(it.lat, it.lon) })
//
